...
export default function Data() {
    return (
        <div className="home__data">
            <h1 className="home__title">Pukar Nepali
            ...
            <h3 className="home__subtitle">Mobile App Developer </h3>
            <p className="home__description">
            A motivated mobile app developer currently learning and growing in Flutter, focused on building cross-platform applications for Android. Eager to gain real-world experience and contribute to meaningful projects.</p>
